...
class SimonRemoveAllZeroTest(BaseAssertions):
    ...
    def test_remove_all_zero_vector_for_two_qubits_0(self):
        ...
        hidden_subgroup = ['00']
        construct_extended_simon_circuit_and_run_for_every_possible_index(hidden_subgroup, [], self.assert_all_zero_not_measured_and_all_results_have_1_at_target_index)


    def test_remove_all_zero_vector_for_two_qubits_1(self):
        hidden_subgroup = ['00', '01']
        construct_extended_simon_circuit_and_run_for_every_possible_index(hidden_subgroup, [], self.assert_all_zero_not_measured_and_all_results_have_1_at_target_index, log_circuit_and_statevector=True)
    ...
    def test_remove_all_zero_vector_for_two_qubits_3(self):
        ...
        construct_extended_simon_circuit_and_run_for_every_possible_index(hidden_subgroup, [], self.assert_only_all_zero_is_measured)
